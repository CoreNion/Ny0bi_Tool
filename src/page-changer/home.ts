...
import { applyDarkTopBar } from "./utilities";
...
export function applyDarkNewHomePage() {
...
export function applyDarkGenrePage() {
...
export function applyDarkMyCourcePage() {
...
export function applyDarkCourcePage() {
...
export function applyDarkForumPage() {
...
export function applyDarkSettingPage() {
